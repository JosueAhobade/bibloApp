                  ...
                  <div class="card-body">
                    ...
                    <form action="/add-books" method="post" class="forms-sample" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="titre" class="form-control" id="exampleInputUsername1" placeholder="Titre du livre" required="" />
                      </div>
                      <div class="form-group">
                        <label for="">Auteur du livre</label>
                        <input type="text" name="auteur" class="form-control" id="exampleInputEmail1" placeholder="Auteur du livre" required="" />
                      </div>
                      <div class="form-group">
                        <label for="">Date de publication</label>
                        <input type="date" name="date_pub" class="form-control" id="exampleInputPassword1" placeholder="Date de publication" required="" />
                      </div>
                      <div class="form-group">
                        <label for="">Maison d'édition</label>
                        <input type="text" name="maison_edition" class="form-control" id="" placeholder="Maison d'édition"  required="" />
                      </div>
                      <div class="form-group">
